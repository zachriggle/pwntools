...
<%page args="string, append_null = True, register1='x14', register2='x15'"/>
<%docstring>
...
Examples:
    ...
    >>> print shellcraft.aarch64.pushstr("Hello!").rstrip()
        ...
        str x14, [sp, #-16]!
    >>> print shellcraft.aarch64.pushstr("Hello, world!").rstrip()
        ...
        stp x14, x15, [sp, #-16]!
    >>> print shellcraft.aarch64.pushstr("Hello, world, bienvenue").rstrip()
...
offset = 0
%>\
    /* push ${shellcraft.pretty(pretty_string)} */
